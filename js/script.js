...
// Function allow mouse control the paddle
...
// Setting up speed, after hitting borders X and Y
function speedUp(){
...
// function that checks the positions of the paddles and ball interact with them and return in oposit direction
 function PaddleHit(){
     // player Paddle
...
//music play, pause , hit paddle sound
function playM(){sound.play();};
function pauseM(){sound.pause();};
function bipM(){bip.play();};
