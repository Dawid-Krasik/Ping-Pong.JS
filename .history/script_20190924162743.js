...
function aiPosition(){
    ...
    // funciont calculating score and chcecing game
function score (){
    let playerPoints = 0;
    let aiPoints = 0;
    if (ballX < 15){
        playerPoints
        console.log("w pentli punkt dla ai" + " " + playerPoints);
      }
    if (ballX > 965) {
        aiPoints++
        console.log("punkt dla gracza" + " " + aiPoints);
    }
  //  console.log ("za pentlą punkt dla ai" + "" + playerPoints);
}
