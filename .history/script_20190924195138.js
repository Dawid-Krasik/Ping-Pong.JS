...
// Fuciont to return ball affter thay hit paddle
...
function aiPosition(){
    ...
    if (ballX <= aiX + paddleWidth / 2 && ballY >= playerY - paddleHieght / 2 && ballY <= playerY + paddleHieght / 2 || ballX >= cw) {
        ballSpeedX = -ballSpeedX;
    }
...
function paddlehits(){
    if (ballX <= playerX + paddleWidth / 2 && ballY >= playerY - paddleHieght / 2 && ballY <= playerY + paddleHieght / 2 || ballX >= cw) {
        ballSpeedX = -ballSpeedX;
    }
